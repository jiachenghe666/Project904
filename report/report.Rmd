...
box_n_DGP1 <- box_plot_final_output(final_output, x_lab = "n", title = "DGP1: constant tau")

load("../output_df/output_d_DGP1.RData")
box_d_DGP1 <- box_plot_final_output(final_output, x_lab = "d", title = "DGP1: constant tau")

load("../output_df/output_n_DGP2.RData")
box_n_DGP2 <- box_plot_final_output(final_output, x_lab = "n", title = "DGP2: heterogeneous tau")

load("../output_df/output_d_DGP2.RData")
box_d_DGP2 <- box_plot_final_output(final_output, x_lab = "d", title = "DGP2: heterogeneous tau")
